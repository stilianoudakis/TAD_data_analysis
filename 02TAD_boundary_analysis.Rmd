...
#We first create 22 empty GRange objects to fill in with 1kb intervals
#for each of the 22 chromosomes
#This is done to create the class variable (response) Y
#Y=1 if the bin is also a flanked tad boundary
#Y=1 if it is not
...
length(unique(queryHits(partial))) #3034
...
```{r}
logitdata <- data.frame(y = mcols(tad_subcomp_full)$y,
