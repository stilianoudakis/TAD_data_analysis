...
#right distance (using precede function)
pre <- precede(none,subcompartgr, select="first")
pre_dist <- distance(none, subcompartgr[pre])

#left distance
foll <- follow(none,subcompartgr, select="last")
foll_dist <- distance(none, subcompartgr[foll])
