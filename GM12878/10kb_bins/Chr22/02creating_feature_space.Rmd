...
binslist10 <- readRDS("C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/chr22/binslist10.rds")
...
bounds <- readRDS("C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/chr22/bounds.rds")
...
for(i in 1:length(grlist)){
  ...
  if(is.element("chr22", as.character(seqnames(grlist[[i]])))){
    grlist[[i]] <- grlist[[i]][which(seqnames(grlist[[i]])=="chr22")]
...
saveRDS(grlist, "C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/chr22/grlist.rds")
...
grlist <- readRDS("C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/chr22/grlist.rds")
