...
se_GM12878_gr_center <- resize(se_GM12878_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$se[queryHits(findOverlaps(binslist10,se_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,se_gr))))
  gm12878_10kb$se[-queryHits(findOverlaps(binslist10,se_gr))] <- 0
