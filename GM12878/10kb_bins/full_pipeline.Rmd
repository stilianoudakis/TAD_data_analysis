---
title: "TAD Data ANalysis: Full Pipeline"
...
#the TAD boundary data was obtained from Rao et al GEO: GSE63525
#the arrowhead algorithm was used to identify TADs using a 5kb resolution contact matrix
...
#the genomic bins were obtained from a 10 kb resolution contact matrix
#since the boundary data used a 5kb resolution contact matrix, this corresponds to a 5kb flank on either side of a TAD boundary (i.e a 10kb sized genomic bin)

binslist10 <- read.table("C:/Users/Spiro Stilianoudakis/Documents/TAD_data/data/10kb_bins/binslist10.txt")
...
saveRDS(binslist10, "C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/binslist10.rds")
...
B_gr_center <- resize(B_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$A <- NA
  gm12878_10kb$A[queryHits(findOverlaps(binslist10,A_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,A_gr))))
  gm12878_10kb$A[-queryHits(findOverlaps(binslist10,A_gr))] <- 0
  
  gm12878_10kb$B <- NA
  gm12878_10kb$B[queryHits(findOverlaps(binslist10,B_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,B_gr))))
  gm12878_10kb$B[-queryHits(findOverlaps(binslist10,B_gr))] <- 0
...
sequence_alteration_gr_center <- resize(sequence_alteration_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$complex[queryHits(findOverlaps(binslist10,complex_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,complex_gr))))
  gm12878_10kb$complex[-queryHits(findOverlaps(binslist10,complex_gr))] <- 0
  
  gm12878_10kb$deletion <- NA
  gm12878_10kb$deletion[queryHits(findOverlaps(binslist10,deletion_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,deletion_gr))))
  gm12878_10kb$deletion[-queryHits(findOverlaps(binslist10,deletion_gr))] <- 0
  
  gm12878_10kb$duplication <- NA
  gm12878_10kb$duplication[queryHits(findOverlaps(binslist10,duplication_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,duplication_gr))))
  gm12878_10kb$duplication[-queryHits(findOverlaps(binslist10,duplication_gr))] <- 0

  gm12878_10kb$gain_loss <- NA
  gm12878_10kb$gain_loss[queryHits(findOverlaps(binslist10,gain_loss_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,gain_loss_gr))))
  gm12878_10kb$gain_loss[-queryHits(findOverlaps(binslist10,gain_loss_gr))] <- 0

  gm12878_10kb$insertion <- NA
  gm12878_10kb$insertion[queryHits(findOverlaps(binslist10,insertion_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,insertion_gr))))
  gm12878_10kb$insertion[-queryHits(findOverlaps(binslist10,insertion_gr))] <- 0

  gm12878_10kb$inversion <- NA
  gm12878_10kb$inversion[queryHits(findOverlaps(binslist10,inversion_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,inversion_gr))))
  gm12878_10kb$inversion[-queryHits(findOverlaps(binslist10,inversion_gr))] <- 0

  gm12878_10kb$mobile_element_insertion <- NA
  gm12878_10kb$mobile_element_insertion[queryHits(findOverlaps(binslist10,mobile_element_insertion_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,mobile_element_insertion_gr))))
  gm12878_10kb$mobile_element_insertion[-queryHits(findOverlaps(binslist10,mobile_element_insertion_gr))] <- 0

  gm12878_10kb$novel_sequence_insertion <- NA
  gm12878_10kb$novel_sequence_insertion[queryHits(findOverlaps(binslist10,novel_sequence_insertion_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,novel_sequence_insertion_gr))))
  gm12878_10kb$novel_sequence_insertion[-queryHits(findOverlaps(binslist10,novel_sequence_insertion_gr))] <- 0
  
  gm12878_10kb$sequence_alteration <- NA
  gm12878_10kb$sequence_alteration[queryHits(findOverlaps(binslist10,sequence_alteration_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,sequence_alteration_gr))))
  gm12878_10kb$sequence_alteration[-queryHits(findOverlaps(binslist10,sequence_alteration_gr))] <- 0
...
gerp_gr_center <- resize(gerp_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$gerp[queryHits(findOverlaps(binslist10,gerp_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,gerp_gr))))
  gm12878_10kb$gerp[-queryHits(findOverlaps(binslist10,gerp_gr))] <- 0
...
SINE_gr_center <- resize(SINE_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$DNA <- NA
  gm12878_10kb$DNA[queryHits(findOverlaps(binslist10,DNA_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,DNA_gr))))
  gm12878_10kb$DNA[-queryHits(findOverlaps(binslist10,DNA_gr))] <- 0
  
  gm12878_10kb$line <- NA
  gm12878_10kb$line[queryHits(findOverlaps(binslist10,line_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,line_gr))))
  gm12878_10kb$line[-queryHits(findOverlaps(binslist10,line_gr))] <- 0
  
  gm12878_10kb$low_complexity <- NA
  gm12878_10kb$low_complexity[queryHits(findOverlaps(binslist10,low_complexity_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,low_complexity_gr))))
  gm12878_10kb$low_complexity[-queryHits(findOverlaps(binslist10,low_complexity_gr))] <- 0
  
  gm12878_10kb$LTR <- NA
  gm12878_10kb$LTR[queryHits(findOverlaps(binslist10,LTR_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,LTR_gr))))
  gm12878_10kb$LTR[-queryHits(findOverlaps(binslist10,LTR_gr))] <- 0
  
  gm12878_10kb$other <- NA
  gm12878_10kb$other[queryHits(findOverlaps(binslist10,other_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,other_gr))))
  gm12878_10kb$other[-queryHits(findOverlaps(binslist10,other_gr))] <- 0
  
  gm12878_10kb$RC <- NA
  gm12878_10kb$RC[queryHits(findOverlaps(binslist10,RC_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,RC_gr))))
  gm12878_10kb$RC[-queryHits(findOverlaps(binslist10,RC_gr))] <- 0
  
  gm12878_10kb$satellite <- NA
  gm12878_10kb$satellite[queryHits(findOverlaps(binslist10,satellite_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,satellite_gr))))
  gm12878_10kb$satellite[-queryHits(findOverlaps(binslist10,satellite_gr))] <- 0
  
  gm12878_10kb$simple_repeat <- NA
  gm12878_10kb$simple_repeat[queryHits(findOverlaps(binslist10,simple_repeat_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,simple_repeat_gr))))
  gm12878_10kb$simple_repeat[-queryHits(findOverlaps(binslist10,simple_repeat_gr))] <- 0
  
  gm12878_10kb$SINE <- NA
  gm12878_10kb$SINE[queryHits(findOverlaps(binslist10,SINE_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,SINE_gr))))
  gm12878_10kb$SINE[-queryHits(findOverlaps(binslist10,SINE_gr))] <- 0
...
se_GM12878_gr_center <- resize(se_GM12878_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$se_GM12878[queryHits(findOverlaps(binslist10,se_GM12878_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,se_GM12878_gr))))
  gm12878_10kb$se_GM12878[-queryHits(findOverlaps(binslist10,se_GM12878_gr))] <- 0
...
VMR_gr_center <- resize(VMR_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$VMR <- NA
  gm12878_10kb$VMR[queryHits(findOverlaps(binslist10,VMR_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,VMR_gr))))
  gm12878_10kb$VMR[-queryHits(findOverlaps(binslist10,VMR_gr))] <- 0
...
Gm12878_TxnTransition_gr_center <- resize(Gm12878_TxnTransition_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$Gm12878_TxnElongation[queryHits(findOverlaps(binslist10,Gm12878_TxnElongation_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_TxnElongation_gr))))
  gm12878_10kb$Gm12878_TxnElongation[-queryHits(findOverlaps(binslist10,Gm12878_TxnElongation_gr))] <- 0
  
  gm12878_10kb$Gm12878_WeakTxn <- NA
  gm12878_10kb$Gm12878_WeakTxn[queryHits(findOverlaps(binslist10,Gm12878_WeakTxn_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_WeakTxn_gr))))
  gm12878_10kb$Gm12878_WeakTxn[-queryHits(findOverlaps(binslist10,Gm12878_WeakTxn_gr))] <- 0
  
  gm12878_10kb$Gm12878_Repressed <- NA
  gm12878_10kb$Gm12878_Repressed[queryHits(findOverlaps(binslist10,Gm12878_Repressed_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_Repressed_gr))))
  gm12878_10kb$Gm12878_Repressed[-queryHits(findOverlaps(binslist10,Gm12878_Repressed_gr))] <- 0
  
  gm12878_10kb$Gm12878_Heterochromlo <- NA
  gm12878_10kb$Gm12878_Heterochromlo[queryHits(findOverlaps(binslist10,Gm12878_Heterochromlo_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_Heterochromlo_gr))))
  gm12878_10kb$Gm12878_Heterochromlo[-queryHits(findOverlaps(binslist10,Gm12878_Heterochromlo_gr))] <- 0
  
  gm12878_10kb$Gm12878_RepetitiveCNV14 <- NA
  gm12878_10kb$Gm12878_RepetitiveCNV14[queryHits(findOverlaps(binslist10,Gm12878_RepetitiveCNV14_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_RepetitiveCNV14_gr))))
  gm12878_10kb$Gm12878_RepetitiveCNV14[-queryHits(findOverlaps(binslist10,Gm12878_RepetitiveCNV14_gr))] <- 0
  
  gm12878_10kb$Gm12878_RepetitiveCNV15 <- NA
  gm12878_10kb$Gm12878_RepetitiveCNV15[queryHits(findOverlaps(binslist10,Gm12878_RepetitiveCNV15_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_RepetitiveCNV15_gr))))
  gm12878_10kb$Gm12878_RepetitiveCNV15[-queryHits(findOverlaps(binslist10,Gm12878_RepetitiveCNV15_gr))] <- 0
  
  gm12878_10kb$Gm12878_ActivePromoter <- NA
  gm12878_10kb$Gm12878_ActivePromoter[queryHits(findOverlaps(binslist10,Gm12878_ActivePromoter_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_ActivePromoter_gr))))
  gm12878_10kb$Gm12878_ActivePromoter[-queryHits(findOverlaps(binslist10,Gm12878_ActivePromoter_gr))] <- 0
  
  gm12878_10kb$Gm12878_WeakPromoter <- NA
  gm12878_10kb$Gm12878_WeakPromoter[queryHits(findOverlaps(binslist10,Gm12878_WeakPromoter_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_WeakPromoter_gr))))
  gm12878_10kb$Gm12878_WeakPromoter[-queryHits(findOverlaps(binslist10,Gm12878_WeakPromoter_gr))] <- 0
  
  gm12878_10kb$Gm12878_PoisedPromoter <- NA
  gm12878_10kb$Gm12878_PoisedPromoter[queryHits(findOverlaps(binslist10,Gm12878_PoisedPromoter_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_PoisedPromoter_gr))))
  gm12878_10kb$Gm12878_PoisedPromoter[-queryHits(findOverlaps(binslist10,Gm12878_PoisedPromoter_gr))] <- 0
  
  gm12878_10kb$Gm12878_StrongEnhancer4 <- NA
  gm12878_10kb$Gm12878_StrongEnhancer4[queryHits(findOverlaps(binslist10,Gm12878_StrongEnhancer4_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_StrongEnhancer4_gr))))
  gm12878_10kb$Gm12878_StrongEnhancer4[-queryHits(findOverlaps(binslist10,Gm12878_StrongEnhancer4_gr))] <- 0
  
  gm12878_10kb$Gm12878_StrongEnhancer5 <- NA
  gm12878_10kb$Gm12878_StrongEnhancer5[queryHits(findOverlaps(binslist10,Gm12878_StrongEnhancer5_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_StrongEnhancer5_gr))))
  gm12878_10kb$Gm12878_StrongEnhancer5[-queryHits(findOverlaps(binslist10,Gm12878_StrongEnhancer5_gr))] <- 0
  
  gm12878_10kb$Gm12878_WeakEnhancer6 <- NA
  gm12878_10kb$Gm12878_WeakEnhancer6[queryHits(findOverlaps(binslist10,Gm12878_WeakEnhancer6_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_WeakEnhancer6_gr))))
  gm12878_10kb$Gm12878_WeakEnhancer6[-queryHits(findOverlaps(binslist10,Gm12878_WeakEnhancer6_gr))] <- 0
  
  gm12878_10kb$Gm12878_WeakEnhancer7 <- NA
  gm12878_10kb$Gm12878_WeakEnhancer7[queryHits(findOverlaps(binslist10,Gm12878_WeakEnhancer7_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_WeakEnhancer7_gr))))
  gm12878_10kb$Gm12878_WeakEnhancer7[-queryHits(findOverlaps(binslist10,Gm12878_WeakEnhancer7_gr))] <- 0
  
  gm12878_10kb$Gm12878_Insulator <- NA
  gm12878_10kb$Gm12878_Insulator[queryHits(findOverlaps(binslist10,Gm12878_Insulator_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_Insulator_gr))))
  gm12878_10kb$Gm12878_Insulator[-queryHits(findOverlaps(binslist10,Gm12878_Insulator_gr))] <- 0
  
  gm12878_10kb$Gm12878_TxnTransition <- NA
  gm12878_10kb$Gm12878_TxnTransition[queryHits(findOverlaps(binslist10,Gm12878_TxnTransition_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_TxnTransition_gr))))
  gm12878_10kb$Gm12878_TxnTransition[-queryHits(findOverlaps(binslist10,Gm12878_TxnTransition_gr))] <- 0
...
Gm12878_WE_gr_center <- resize(Gm12878_WE_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$Gm12878_CTCF[queryHits(findOverlaps(binslist10,Gm12878_CTCF_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_CTCF_gr))))
  gm12878_10kb$Gm12878_CTCF[-queryHits(findOverlaps(binslist10,Gm12878_CTCF_gr))] <- 0
  
  gm12878_10kb$Gm12878_E <- NA
  gm12878_10kb$Gm12878_E[queryHits(findOverlaps(binslist10,Gm12878_E_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_E_gr))))
  gm12878_10kb$Gm12878_E[-queryHits(findOverlaps(binslist10,Gm12878_E_gr))] <- 0
  
  gm12878_10kb$Gm12878_PF <- NA
  gm12878_10kb$Gm12878_PF[queryHits(findOverlaps(binslist10,Gm12878_PF_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_PF_gr))))
  gm12878_10kb$Gm12878_PF[-queryHits(findOverlaps(binslist10,Gm12878_PF_gr))] <- 0
  
  gm12878_10kb$Gm12878_R <- NA
  gm12878_10kb$Gm12878_R[queryHits(findOverlaps(binslist10,Gm12878_R_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_R_gr))))
  gm12878_10kb$Gm12878_R[-queryHits(findOverlaps(binslist10,Gm12878_R_gr))] <- 0
  
  gm12878_10kb$Gm12878_T <- NA
  gm12878_10kb$Gm12878_T[queryHits(findOverlaps(binslist10,Gm12878_T_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_T_gr))))
  gm12878_10kb$Gm12878_T[-queryHits(findOverlaps(binslist10,Gm12878_T_gr))] <- 0
  
  gm12878_10kb$Gm12878_TSS <- NA
  gm12878_10kb$Gm12878_TSS[queryHits(findOverlaps(binslist10,Gm12878_TSS_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_TSS_gr))))
  gm12878_10kb$Gm12878_TSS[-queryHits(findOverlaps(binslist10,Gm12878_TSS_gr))] <- 0
  
  gm12878_10kb$Gm12878_WE <- NA
  gm12878_10kb$Gm12878_WE[queryHits(findOverlaps(binslist10,Gm12878_WE_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_WE_gr))))
  gm12878_10kb$Gm12878_WE[-queryHits(findOverlaps(binslist10,Gm12878_WE_gr))] <- 0
...
Gm12878_DNaseI_gr_center <- resize(Gm12878_DNaseI_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$Gm12878_DNaseI[queryHits(findOverlaps(binslist10,Gm12878_DNaseI_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_DNaseI_gr))))
  gm12878_10kb$Gm12878_DNaseI[-queryHits(findOverlaps(binslist10,Gm12878_DNaseI_gr))] <- 0
...
Gm12878_H4k20me1_gr_center <- resize(Gm12878_H4k20me1_gr, width = 1, fix = "center")
  ...
  gm12878_10kb$Gm12878_H2az[queryHits(findOverlaps(binslist10,Gm12878_H2az_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H2az_gr))))
  gm12878_10kb$Gm12878_H2az[-queryHits(findOverlaps(binslist10,Gm12878_H2az_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k27ac <- NA
  gm12878_10kb$Gm12878_H3k27ac[queryHits(findOverlaps(binslist10,Gm12878_H3k27ac_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k27ac_gr))))
  gm12878_10kb$Gm12878_H3k27ac[-queryHits(findOverlaps(binslist10,Gm12878_H3k27ac_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k27me3 <- NA
  gm12878_10kb$Gm12878_H3k27me3[queryHits(findOverlaps(binslist10,Gm12878_H3k27me3_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k27me3_gr))))
  gm12878_10kb$Gm12878_H3k27me3[-queryHits(findOverlaps(binslist10,Gm12878_H3k27me3_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k36me3 <- NA
  gm12878_10kb$Gm12878_H3k36me3[queryHits(findOverlaps(binslist10,Gm12878_H3k36me3_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k36me3_gr))))
  gm12878_10kb$Gm12878_H3k36me3[-queryHits(findOverlaps(binslist10,Gm12878_H3k36me3_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k4me1 <- NA
  gm12878_10kb$Gm12878_H3k4me1[queryHits(findOverlaps(binslist10,Gm12878_H3k4me1_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k4me1_gr))))
  gm12878_10kb$Gm12878_H3k4me1[-queryHits(findOverlaps(binslist10,Gm12878_H3k4me1_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k4me2 <- NA
  gm12878_10kb$Gm12878_H3k4me2[queryHits(findOverlaps(binslist10,Gm12878_H3k4me2_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k4me2_gr))))
  gm12878_10kb$Gm12878_H3k4me2[-queryHits(findOverlaps(binslist10,Gm12878_H3k4me2_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k4me3 <- NA
  gm12878_10kb$Gm12878_H3k4me3[queryHits(findOverlaps(binslist10,Gm12878_H3k4me3_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k4me3_gr))))
  gm12878_10kb$Gm12878_H3k4me3[-queryHits(findOverlaps(binslist10,Gm12878_H3k4me3_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k79me2 <- NA
  gm12878_10kb$Gm12878_H3k79me2[queryHits(findOverlaps(binslist10,Gm12878_H3k79me2_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k79me2_gr))))
  gm12878_10kb$Gm12878_H3k79me2[-queryHits(findOverlaps(binslist10,Gm12878_H3k79me2_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k9ac <- NA
  gm12878_10kb$Gm12878_H3k9ac[queryHits(findOverlaps(binslist10,Gm12878_H3k9ac_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k9ac_gr))))
  gm12878_10kb$Gm12878_H3k9ac[-queryHits(findOverlaps(binslist10,Gm12878_H3k9ac_gr))] <- 0
  
  gm12878_10kb$Gm12878_H3k9me3 <- NA
  gm12878_10kb$Gm12878_H3k9me3[queryHits(findOverlaps(binslist10,Gm12878_H3k9me3_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H3k9me3_gr))))
  gm12878_10kb$Gm12878_H3k9me3[-queryHits(findOverlaps(binslist10,Gm12878_H3k9me3_gr))] <- 0
  
  gm12878_10kb$Gm12878_H4k20me1 <- NA
  gm12878_10kb$Gm12878_H4k20me1[queryHits(findOverlaps(binslist10,Gm12878_H4k20me1_gr))] <- width(ranges(pintersect(findOverlapPairs(binslist10,Gm12878_H4k20me1_gr))))
  gm12878_10kb$Gm12878_H4k20me1[-queryHits(findOverlaps(binslist10,Gm12878_H4k20me1_gr))] <- 0
...
saveRDS(grlist, "C:/Users/Spiro Stilianoudakis/Documents/TAD_data/RData/GM12878/10kb_bins/grlist.rds")
...
```{r}
gm12878_10kb <- gm12878_10kb[,c("y", grep("dist",colnames(gm12878_10kb)))]
```
...
enetlst_ls <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_f$y=="Yes"))*2)*.3), 
                   ...
                   varimp <- matrix(nrow=dim(chr1_gm12878_f)[2]-1,
                                    ncol=bootsamps))
rownames(enetlst_ls[[3]]) <- colnames(chr1_gm12878_f)[-1]
...
```{r}
gm12878_10kb_f_nl <- gm12878_10kb
...
enetlst_nls <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_f$y=="Yes"))*2)*.3), 
                    ...
                    varimp <- matrix(nrow=dim(chr1_gm12878_f)[2]-1,
                                     ncol=bootsamps))
rownames(enetlst_nls[[3]]) <- colnames(chr1_gm12878_f)[-1]
...
#null model
glm.null <- glm(y ~ 1, data = chr1_gm12878_f, family = binomial)

#full model
glm.full <- glm(y ~ ., data = chr1_gm12878_f, family = binomial)
...
namesmat <- matrix(NA,nrow=dim(chr1_gm12878_f)[2]-1, ncol=bootsamps)
rownames(namesmat) <- sort(names(chr1_gm12878_f)[-which(names(chr1_gm12878_f)=="y")])
...
chr1_gm12878_fwd <- chr1_gm12878_f[,which((names(chr1_gm12878_f) %in% fwd.preds) | names(chr1_gm12878_f)=="y")]
...
enetlst_fwd <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_fwd$y=="Yes"))*2)*.3), 
                    ...
                    varimp <- matrix(nrow=dim(chr1_gm12878_fwd)[2]-1,
                                     ncol=bootsamps))
rownames(enetlst_fwd[[3]]) <- colnames(chr1_gm12878_fwd)[-1]
...
chr1_gm12878_bwd <- chr1_gm12878_f[,which((names(chr1_gm12878_f) %in% bwd.preds) | names(chr1_gm12878_f)=="y")]
...
enetlst_bwd <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_bwd$y=="Yes"))*2)*.3), 
                    ...
                    varimp <- matrix(nrow=dim(chr1_gm12878_bwd)[2]-1,
                                     ncol=bootsamps))
rownames(enetlst_bwd[[3]]) <- colnames(chr1_gm12878_bwd)[-1]
...
chr1_gm12878_both <- chr1_gm12878_f[,which((names(chr1_gm12878_f) %in% both.preds) | names(chr1_gm12878_f)=="y")]
...
enetlst_both <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_both$y=="Yes"))*2)*.3), 
                    ...
                    varimp <- matrix(nrow=dim(chr1_gm12878_both)[2]-1,
                                     ncol=bootsamps))
rownames(enetlst_both[[3]]) <- colnames(chr1_gm12878_both)[-1]
...
chr1_gm12878_rfe <- chr1_gm12878_f[,which((names(chr1_gm12878_f) %in% rfe.preds) | names(chr1_gm12878_f)=="y")]
...
#set length of list objects that will be filled in with specificities
#and sensitivities and aucs and variable importance
enetlst_rfe <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_rfe$y=="Yes"))*2)*.3), 
                                  ncol=bootsamps),
                    fpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_rfe$y=="Yes"))*2)*.3), 
                                  ncol=bootsamps),
                    varimp <- matrix(nrow=dim(chr1_gm12878_rfe)[2]-1,
                                     ncol=bootsamps))
rownames(enetlst_rfe[[3]]) <- colnames(chr1_gm12878_rfe)[-1]
...
for(i in 1:bootsamps){
  set.seed(7215)
  #combining the two classes to create balanced data
  data <- rbind.data.frame(chr1_gm12878_rfe[which(chr1_gm12878_rfe$y=="Yes"),],
                           chr1_gm12878_rfe[sampids[,i],])
...
rflst <- list(tpr <- matrix(nrow=ceiling((length(which(chr1_gm12878_fwd$y=="Yes"))*2)*.3), 
                ...
                varimp <- matrix(nrow=dim(chr1_gm12878_fwd)[2]-1,
                                 ncol=bootsamps))
rownames(rflst[[3]]) <- colnames(chr1_gm12878_fwd)[-1]
