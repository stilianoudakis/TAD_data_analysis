...
rownames(mouradperf) <- c("TN",
  ...
  mouradperf[10,1] <- confMat$table[2,2]/(confMat$table[2,2]+confMat$table[2,1])
  mouradperf[11,1] <- confMat$table[2,1]/(confMat$table[2,1]+confMat$table[1,1])
  mouradperf[12,1] <- confMat$table[1,2]/(confMat$table[1,2]+confMat$table[2,2])
  mouradperf[13,1] <- confMat$table[1,2]/(confMat$table[1,2]+confMat$table[1,1])
  mouradperf[14,1] <- confMat$table[1,1]/(confMat$table[1,1]+confMat$table[1,2])
  #mouradperf[15,1] <- mccr(ifelse(test$y=="Yes",1,0),ifelse(pred.enetModel2=="Yes",1,0))
  mouradperf[15,1] <- (TP*TN - FP*FN)/( sqrt( (TP+FP)*(TP+FN)*(TN+FP)*(TN+FN) ) )
  mouradperf[16,1] <- (2*(confMat$table[2,2]/(confMat$table[2,2]+confMat$table[1,2]))*(confMat$table[2,2]/(confMat$table[2,2]+confMat$table[2,1])))/(((confMat$table[2,2]/(confMat$table[2,2]+confMat$table[1,2]))*(confMat$table[2,2]/(confMat$table[2,2]+confMat$table[2,1]))) + (confMat$table[2,2]/(confMat$table[2,2]+confMat$table[2,1])))
