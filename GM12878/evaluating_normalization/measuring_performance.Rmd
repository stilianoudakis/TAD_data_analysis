...
p.ls <- ggplot(varimp.ls.df, aes(x=Feature, y=Importance)) +
  ...
  coord_flip() +
  theme_minimal() +
  ggtitle("Variable Importance Plot: Log Transformed & Standardized")
p.ls
...
p.lns <- ggplot(varimp.lns.df, aes(x=Feature, y=Importance)) +
  ...
  coord_flip() +
  theme_minimal() +
  ggtitle("Variable Importance Plot: Log Transformed & Un-Standardized")
p.lns
...
p.nls <- ggplot(varimp.nls.df, aes(x=Feature, y=Importance)) +
  ...
  coord_flip() +
  theme_minimal() +
  ggtitle("Variable Importance Plot: Not Log Transformed & Standardized")
p.nls
