...
tandem_duplication_gr <- GRanges(seqnames=tandem_duplication$V1,IRanges(start=tandem_duplication$V2,end=tandem_duplication$V3))
  ...
  gs12878$complex <- ifelse(countOverlaps(tad_subcomp_full,complex_gr)>=1,1,0)
  gs12878$deletion <- ifelse(countOverlaps(tad_subcomp_full,deletion_gr)>=1,1,0)
  gs12878$duplication <- ifelse(countOverlaps(tad_subcomp_full,duplication_gr)>=1,1,0)
  gs12878$gain_loss <- ifelse(countOverlaps(tad_subcomp_full,gain_loss_gr)>=1,1,0)
  gs12878$insertion <- ifelse(countOverlaps(tad_subcomp_full,insertion_gr)>=1,1,0)
  gs12878$inversion <- ifelse(countOverlaps(tad_subcomp_full,inversion_gr)>=1,1,0)
  gs12878$mobile_element_insertion <- ifelse(countOverlaps(tad_subcomp_full,mobile_element_insertion_gr)>=1,1,0)
  gs12878$novel_sequence_insertion <- ifelse(countOverlaps(tad_subcomp_full,novel_sequence_insertion_gr)>=1,1,0)
  gs12878$sequence_alteration <- ifelse(countOverlaps(tad_subcomp_full,sequence_alteration_gr)>=1,1,0)
  gs12878$tandem_duplication <- ifelse(countOverlaps(tad_subcomp_full,tandem_duplication_gr)>=1,1,0)
  
  gs12878$complex_dist <- mcols(distanceToNearest(tad_subcomp_dist, complex_gr))$distance
  gs12878$deletion_dist <- mcols(distanceToNearest(tad_subcomp_dist, deletion_gr))$distance
  gs12878$duplication_dist <- mcols(distanceToNearest(tad_subcomp_dist, duplication_gr))$distance
  gs12878$gain_loss_dist <- mcols(distanceToNearest(tad_subcomp_dist, gain_loss_gr))$distance
  gs12878$insertion_dist <- mcols(distanceToNearest(tad_subcomp_dist, insertion_gr))$distance
  gs12878$inversion_dist <- mcols(distanceToNearest(tad_subcomp_dist, inversion_gr))$distance
  gs12878$mobile_element_insertion_dist <- mcols(distanceToNearest(tad_subcomp_dist, mobile_element_insertion_gr))$distance
  gs12878$novel_sequence_insertion_dist <- mcols(distanceToNearest(tad_subcomp_dist, novel_sequence_insertion_gr))$distance
  gs12878$sequence_alteration_dist <- mcols(distanceToNearest(tad_subcomp_dist, sequence_alteration_gr))$distance
  gs12878$tandem_duplication_dist <- mcols(distanceToNearest(tad_subcomp_dist, tandem_duplication_gr))$distance
...
mcols(gerp_gr)$score <- gerp$V5
  ...
  gs12878$gerp <- ifelse(countOverlaps(tad_subcomp_full,gerp_gr)>=1,1,0)
  
  gs12878$gerp_dist <- mcols(distanceToNearest(tad_subcomp_dist, gerp_gr))$distance
  
#finding which flanks overlap the gerp file so that we can add a score variable
#all other flanks will have a score of 0
which(gs12878$gerp==1)
gs12878$gerp_score <- 0
...
gs12878$gerp_score[gerpoverlapmean$Group.1] <- gerpoverlapmean$x
...
unknown_gr <- GRanges(seqnames=unknown$V1,IRanges(start=unknown$V2,end=unknown$V3))
  ...
  gs12878$DNA <- ifelse(countOverlaps(tad_subcomp_full,DNA_gr)>=1,1,0)
  gs12878$line <- ifelse(countOverlaps(tad_subcomp_full,line_gr)>=1,1,0)
  gs12878$low_complexity <- ifelse(countOverlaps(tad_subcomp_full,low_complexity_gr)>=1,1,0)
  gs12878$LTR <- ifelse(countOverlaps(tad_subcomp_full,LTR_gr)>=1,1,0)
  gs12878$other <- ifelse(countOverlaps(tad_subcomp_full,other_gr)>=1,1,0)
  gs12878$RC <- ifelse(countOverlaps(tad_subcomp_full,RC_gr)>=1,1,0)
  gs12878$RNA <- ifelse(countOverlaps(tad_subcomp_full,RNA_gr)>=1,1,0)
  gs12878$rRNA <- ifelse(countOverlaps(tad_subcomp_full,rRNA_gr)>=1,1,0)
  gs12878$satellite <- ifelse(countOverlaps(tad_subcomp_full,satellite_gr)>=1,1,0)
  gs12878$scRNA <- ifelse(countOverlaps(tad_subcomp_full,scRNA_gr)>=1,1,0)
  gs12878$simple_repeat <- ifelse(countOverlaps(tad_subcomp_full,simple_repeat_gr)>=1,1,0)
  gs12878$SINE <- ifelse(countOverlaps(tad_subcomp_full,SINE_gr)>=1,1,0)
  gs12878$snRNA <- ifelse(countOverlaps(tad_subcomp_full,snRNA_gr)>=1,1,0)
  gs12878$srpRNA <- ifelse(countOverlaps(tad_subcomp_full,srpRNA_gr)>=1,1,0)
  gs12878$tRNA <- ifelse(countOverlaps(tad_subcomp_full,tRNA_gr)>=1,1,0)
  gs12878$unknown <- ifelse(countOverlaps(tad_subcomp_full,unknown_gr)>=1,1,0)
  
  gs12878$DNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, DNA_gr))$distance 
  gs12878$line_dist <- mcols(distanceToNearest(tad_subcomp_dist, line_gr))$distance 
  gs12878$low_complexity_dist <- mcols(distanceToNearest(tad_subcomp_dist, low_complexity_gr))$distance 
  gs12878$LTR_dist <- mcols(distanceToNearest(tad_subcomp_dist, LTR_gr))$distance 
  gs12878$other_dist <- mcols(distanceToNearest(tad_subcomp_dist, other_gr))$distance 
  gs12878$RC_dist <- mcols(distanceToNearest(tad_subcomp_dist, RC_gr))$distance 
  #gs12878$RNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, RNA_gr))$distance 
  #gs12878$rRNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, rRNA_gr))$distance 
  gs12878$satellite_dist <- mcols(distanceToNearest(tad_subcomp_dist, satellite_gr))$distance 
  #gs12878$scRNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, scRNA_gr))$distance 
  gs12878$simple_repeat_dist <- mcols(distanceToNearest(tad_subcomp_dist, simple_repeat_gr))$distance 
  gs12878$SINE_dist <- mcols(distanceToNearest(tad_subcomp_dist, SINE_gr))$distance 
  #gs12878$snRNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, snRNA_gr))$distance 
  gs12878$srpRNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, srpRNA_gr))$distance 
  #gs12878$tRNA_dist <- mcols(distanceToNearest(tad_subcomp_dist, tRNA_gr))$distance 
  gs12878$unknown_dist <- mcols(distanceToNearest(tad_subcomp_dist, unknown_gr))$distance 
...
se_GM12878_gr <- GRanges(seqnames=se_GM12878$V1,IRanges(start=se_GM12878$V2,end=se_GM12878$V3))
  ...
  gs12878$se_GM12878 <- ifelse(countOverlaps(tad_subcomp_full,se_GM12878_gr)>=1,1,0)
  
  gs12878$se_GM12878_dist <- mcols(distanceToNearest(tad_subcomp_dist, se_GM12878_gr))$distance
...
mcols(UCNE_gr)$score <- UCNE$V5
  ...
  gs12878$UCNE <- ifelse(countOverlaps(tad_subcomp_full,UCNE_gr)>=1,1,0)
  
  gs12878$UCNE_dist <- mcols(distanceToNearest(tad_subcomp_dist, UCNE_gr))$distance
  
#finding which flanks overlap the unce file so that we can add a score variable
#all other flanks will have a score of 0
which(gs12878$UCNE==1)
gs12878$UCNE_score <- 0
...
gs12878$UCNE_score[UCNEoverlapmean$Group.1] <- UCNEoverlapmean$x
...
VMR_gr <- GRanges(seqnames=VMR$V1,IRanges(start=VMR$V2,end=VMR$V3))
  ...
  gs12878$VMR <- ifelse(countOverlaps(tad_subcomp_full,VMR_gr)>=1,1,0)
  
  gs12878$VMR_dist <- mcols(distanceToNearest(tad_subcomp_dist, VMR_gr))$distance
...
Gm12878_TxnTransition_gr <- GRanges(seqnames=Gm12878_TxnTransition$V1,IRanges(start=Gm12878_TxnTransition$V2,end=Gm12878_TxnTransition$V3)) 
  ...
  gs12878$Gm12878_TxnElongation <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_TxnElongation_gr)>=1,1,0)
  gs12878$Gm12878_WeakTxn <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_WeakTxn_gr)>=1,1,0)
  gs12878$Gm12878_Repressed <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_Repressed_gr)>=1,1,0)
  gs12878$Gm12878_Heterochromlo <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_Heterochromlo_gr)>=1,1,0)
  gs12878$Gm12878_RepetitiveCNV14 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_RepetitiveCNV14_gr)>=1,1,0)
  gs12878$Gm12878_RepetitiveCNV15 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_RepetitiveCNV15_gr)>=1,1,0)
  gs12878$Gm12878_ActivePromoter <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_ActivePromoter_gr)>=1,1,0)
  gs12878$Gm12878_WeakPromoter <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_WeakPromoter_gr)>=1,1,0)
  gs12878$Gm12878_PoisedPromoter <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_PoisedPromoter_gr)>=1,1,0)
  gs12878$Gm12878_StrongEnhancer4 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_StrongEnhancer4_gr)>=1,1,0)
  gs12878$Gm12878_StrongEnhancer5 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_StrongEnhancer5_gr)>=1,1,0)
  gs12878$Gm12878_WeakEnhancer6 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_WeakEnhancer6_gr)>=1,1,0)
  gs12878$Gm12878_WeakEnhancer7 <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_WeakEnhancer7_gr)>=1,1,0)
  gs12878$Gm12878_Insulator <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_Insulator_gr)>=1,1,0)
  gs12878$Gm12878_TxnTransition <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_TxnTransition_gr)>=1,1,0)

  gs12878$Gm12878_TxnElongation_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_TxnElongation_gr))$distance
  gs12878$Gm12878_WeakTxn_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_WeakTxn_gr))$distance
  gs12878$Gm12878_Repressed_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_Repressed_gr))$distance
  gs12878$Gm12878_Heterochromlo_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_Heterochromlo_gr))$distance
  gs12878$Gm12878_RepetitiveCNV14_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_RepetitiveCNV14_gr))$distance
  gs12878$Gm12878_RepetitiveCNV15_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_RepetitiveCNV15_gr))$distance
  gs12878$Gm12878_ActivePromoter_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_ActivePromoter_gr))$distance
  gs12878$Gm12878_WeakPromoter_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_WeakPromoter_gr))$distance
  gs12878$Gm12878_PoisedPromoter_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_PoisedPromoter_gr))$distance
  gs12878$Gm12878_StrongEnhancer4_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_StrongEnhancer4_gr))$distance
  gs12878$Gm12878_StrongEnhancer5_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_StrongEnhancer5_gr))$distance
  gs12878$Gm12878_WeakEnhancer6_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_WeakEnhancer6_gr))$distance
  gs12878$Gm12878_WeakEnhancer7_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_WeakEnhancer7_gr))$distance
  gs12878$Gm12878_Insulator_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_Insulator_gr))$distance
  gs12878$Gm12878_TxnTransition_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_TxnTransition_gr))$distance
...
Gm12878_WE_gr <- GRanges(seqnames=Gm12878_WE$V1,IRanges(start=Gm12878_WE$V2,end=Gm12878_WE$V3))
  ...
  gs12878$Gm12878_CTCF <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_CTCF_gr)>=1,1,0) 
  gs12878$Gm12878_E <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_E_gr)>=1,1,0)
  gs12878$Gm12878_PF <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_PF_gr)>=1,1,0)
  gs12878$Gm12878_R <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_R_gr)>=1,1,0)
  gs12878$Gm12878_T <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_T_gr)>=1,1,0)
  gs12878$Gm12878_TSS <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_TSS_gr)>=1,1,0)
  gs12878$Gm12878_WE <- ifelse(countOverlaps(tad_subcomp_full,Gm12878_WE_gr)>=1,1,0)

  gs12878$Gm12878_CTCF_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_CTCF_gr))$distance
  gs12878$Gm12878_E_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_CTCF_gr))$distance
  gs12878$Gm12878_PF_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_PF_gr))$distance
  gs12878$Gm12878_R_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_R_gr))$distance
  gs12878$Gm12878_T_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_T_gr))$distance
  gs12878$Gm12878_TSS_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_TSS_gr))$distance
  gs12878$Gm12878_WE_dist <- mcols(distanceToNearest(tad_subcomp_dist, Gm12878_WE_gr))$distance
...
gs12878$CHR <- seqnames(tad_subcomp_full)

gs12878$CHR <- as.character(gs12878$CHR)
```
