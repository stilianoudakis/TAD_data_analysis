...
bins[[i]] <- GRanges(seqnames=seqn, 
                ranges=IRanges(start=seq(min(allcoords$coordinate[which(allcoords$Chromosome==unique(allcoords$Chromosome)[i])])-500, 
                                         max(allcoords$coordinate[which(allcoords$Chromosome==unique(allcoords$Chromosome)[i])])+500,
                                         1000),
                               width=1000))
